...
<body>
	...
	<div id="joinForm">
         ...
         <form id="joinSubmitForm" action="/modang/user/join" method="get" enctype="multipart/form-data">
            ...
            <div class="form-group">    
                <div class="shadow-none p-1 mb-2 bg-light rounded input-group w-25">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                  <input id="nick" type="text" value="" maxlength="7" class="form-control" name="nick" placeholder="NICK">
                  <button type="button" class="btn btn-Dark" >&nbsp;&nbsp;확인&nbsp;&nbsp;</button>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="shadow-none p-1 mb-2 bg-light rounded input-group w-25">
                  ...
                  <button type="button" class="btn btn-Dark">  &nbsp;&nbsp;인증&nbsp;&nbsp;  </button>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="shadow-none p-1 mb-2 bg-light rounded input-group w-25">
                  <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                  <input id="average" type="text" value="" maxlength="3" class="form-control" name="average" placeholder="타수[VALUE]">
                  <button type="button" class="btn btn-Dark">  &nbsp;&nbsp;입력&nbsp;&nbsp;  </button>
                </div>
            </div>
